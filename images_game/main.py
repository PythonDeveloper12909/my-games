...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load("space invader player ship.xcf")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load("space invader blue enemy.xcf")
        self.rect=self.image.get_rect(midbottom=(450,-5))
        self.image2=pygame.image.load("space invader enemy yellow.xcf")
        self.rect2=self.image2.get_rect(midbottom=(350,-5))
        self.image3=pygame.image.load("space invader enemy pink.xcf")
...
background=pygame.image.load("space invaders background.jpg").convert_alpha()
player=pygame.image.load("space invader player ship.xcf").convert_alpha()
player_rect=player.get_rect(midbottom=(400,555))
enemy_blue=pygame.image.load("space invader blue enemy.xcf").convert_alpha()
enemy_pink=pygame.image.load("space invader enemy pink.xcf").convert_alpha()
enemy_yellow=pygame.image.load("space invader enemy yellow.xcf").convert_alpha()
