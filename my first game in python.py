...
class Player(pygame.sprite.Sprite):
       def __init__(self):
              super().__init__()
              self.image2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop2.xcf').convert_alpha()
              self.gravity=0
              self.character2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop.xcf').convert_alpha()
              self.character1=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop2.xcf').convert_alpha()
              self.character3=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop3.xcf').convert_alpha()
              self.character4=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop4.xcf').convert_alpha()
              self.character=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop2.xcf').convert_alpha()
              ...
              self.sound=pygame.mixer.Sound('C:\\Users\\Ansh\\Desktop\\images_game\\jump sound.wav')
...
class Obstacles(pygame.sprite.Sprite):
        def __init__(self,type):
                super().__init__() 
                if type=='fly':
                        bird1=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop3.xcf').convert_alpha()
                        bird4=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop1.xcf').convert_alpha()
                        bird2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop2.xcf').convert_alpha()
                        bird3=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop4.xcf').convert_alpha()
                        self.frames=[bird1,bird2,bird3,bird4]
                        self.y_pos=350
                else:
                        snail2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\snail.xcf').convert_alpha()
                        snail=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\snail2.xcf').convert_alpha()
...
surface = pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\background2.png')
...
character2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop.xcf').convert_alpha()
character1=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop2.xcf').convert_alpha()
character3=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop3.xcf').convert_alpha()
character4=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop4.xcf').convert_alpha()
character=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\characterop2.xcf').convert_alpha()
...
bird1=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop1.xcf').convert_alpha()
bird2=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop2.xcf').convert_alpha()
bird3=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop3.xcf').convert_alpha()
bird4=pygame.image.load('C:\\Users\\Ansh\\Desktop\\images_game\\birdop4.xcf').convert_alpha()
...
backgroundsound=pygame.mixer.Sound('C:\\Users\\Ansh\\Desktop\\images_game\\background sound.wav')
while True:
